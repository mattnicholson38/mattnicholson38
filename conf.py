...
BLOG_AUTHOR = "MJN"  # (translatable)
BLOG_TITLE = "Survivorship Bias and Mutual Fund Investing"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://mattnicholson38.github.io/mattnicholson38/index,html"
...
FRONT_INDEX_HEADER = {
    DEFAULT_LANG: 'This is the front index header.'
}
...
IPYNB_CONFIG = {'TemplateExporter': {'exclude_output_prompt': True, 'exclude_input': True, 'exclude_input_prompt': True}}
